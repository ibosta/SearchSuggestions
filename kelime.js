...
$(document).ready(function() {
    $("#search").keyup(function(){
		var html = '';
	   	...
	   	html = html + '<th width="16%" align="left">Yahoo</th>'
	   	html = html + '<th width="16%" align="left">Bing</th>'
	   	html = html + '<th width="16%" align="left">Youtube</th>'
	   	html = html + '<th width="16%" align="left">Amazon</th>'
	   	html = html + '<th width="16%" align="left">Ebay</th>'	   	
	   	html = html + '</tr>'	
	   	html = html + '<tr><td id="google"></td><td id="yahoo"></td><td id="bing"></td><td id="youtube"></td><td id="amazon"></td><td id="ebay"></td></tr>'
